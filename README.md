This repository implements a 3-layer neural network designed to differentiate benign and malignant breast cancer diagnoses. python library PyTorch is used inorder to implement this.
